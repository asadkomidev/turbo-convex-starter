...
const ResponsiveModalVariants = cva(
  cn(
    "fixed z-50 gap-2 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto",
    "lg:left-[50%] lg:top-[50%] lg:grid lg:w-full lg:max-w-lg lg:translate-x-[-50%] lg:translate-y-[-50%] lg:border lg:duration-200 lg:data-[state=open]:animate-in lg:data-[state=closed]:animate-out lg:data-[state=closed]:fade-out-0 lg:data-[state=open]:fade-in-0 lg:data-[state=closed]:zoom-out-95 lg:data-[state=open]:zoom-in-95 lg:data-[state=closed]:slide-out-to-bottom-1/2 lg:data-[state=closed]:slide-out-to-bottom-[100%] lg:data-[state=open]:slide-in-from-bottom-1/2 lg:data-[state=open]:slide-in-from-bottom-[100%] lg:rounded-xl"
  ),
  {
    variants: {
      side: {
...
>(
  (
    { side = "bottom", className, showClose = true, children, ...props },
    ref
  ) => (
